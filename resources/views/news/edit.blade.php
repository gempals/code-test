            ...
            <div class="grid_12">
                <div class="block-border">
                    ...
                    <div class="block-content  form">
                        {!! Form::model($data, ['method' => 'PUT', 'route' => ['news.update',  $data->id ],'class'=>'form-horizontal' ]) !!}
                        <fieldset>
                            <legend>Ubah</legend>
...
<script type="text/javascript">
  ...
  $('.pubdate').datepicker({ dateFormat: 'dd-mm-yy'}).datepicker("setDate", new Date("{{$data->publish_date}}"));;
