         ...
         <!-- start single archive post -->
            <div class="single_archiveblog">                           
              ...
              @else
                <div class="contact_left wow fadeInLeft">
                <h4>Balas Pesan</h4>
                <form class="submitphoto_form" method="POST" action="{{ route('forum_post') }}" >
                  {{ csrf_field() }}                           
                  ...
                  <input type="hidden" value="{{$data_main['id']}}" name="forum_id"></input>
                  <input type="hidden" value="{{$data_main['forum_categories_id']}}" name="forum_cat"></input>
