            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '10.20.222.10 10.20.222.11')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'CN=dmsuser,OU=CIST,OU=SLP,dc=sig,dc=com'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'sig\dmsadmin'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Document2017'),
